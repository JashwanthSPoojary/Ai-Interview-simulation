...
import { FileIcon, UploadIcon, CheckCircle, AlertCircle, FileText, Loader } from "lucide-react"// import type { PutBlobResult } from "@vercel/blob"
...
export function ResumeUpload() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setUploadResult({
        success: false,
        message: "Failed to upload resume. Please try again or Maybe Backend is down . Will fix asap",
      })
    } finally {
      setUploading(false)
    }
